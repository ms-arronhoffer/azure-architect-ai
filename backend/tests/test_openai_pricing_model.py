...
``azure_openai_deployment_pricing`` (gpt-5.6-sol by default) rather than the
...
def test_pricing_default_deployment_is_gpt56_sol():
    from services import openai_service

    assert openai_service.settings.azure_openai_deployment_pricing == "gpt-5.6-sol"
