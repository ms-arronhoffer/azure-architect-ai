...
TOOLS_BY_MODE: dict[str, list] = {
    ...
    "compsku":          get_tools("search_azure_docs", "estimate_costs", "generate_bicep",
                                  "generate_terraform"),
    ...
    "compdisk":         get_tools("search_azure_docs", "generate_bicep", "generate_terraform",
                                  "estimate_costs"),
    "compha":           get_tools("search_azure_docs", "generate_bicep", "generate_terraform",
                                  "assess_waf_pillar"),
    "compdr":           get_tools("search_azure_docs", "design_dr_strategy",
    ...
    "aiiac":       get_tools("search_azure_docs", "generate_bicep", "generate_terraform",
                             "generate_arm", "validate_resource_naming",
                             "suggest_resource_name"),
    # ── Data Desk specialists (Azure-only) ──
    "datalake":        get_tools("search_azure_docs", "generate_bicep", "generate_terraform",
                                 "estimate_costs"),
    ...
    "datastream":      get_tools("search_azure_docs", "design_architecture", "generate_bicep",
                                 "generate_terraform"),
    "datalakehouse":   get_tools("search_azure_docs", "design_medallion_schema", "generate_bicep",
                                 "generate_terraform"),
    ...
    "dataiac":         get_tools("search_azure_docs", "generate_bicep", "generate_terraform",
                                 "generate_arm", "validate_resource_naming",
                                 "suggest_resource_name"),
}
